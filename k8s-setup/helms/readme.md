...
helm template nginx-chart --values stagging-value.yaml
...
```bash
# outside folder 
helm install planting-k8s nginx-chart --values nginx-chart/stagging-values.yaml
helm upgrade planting-k8s nginx-chart --values nginx-chart/stagging-values.yaml
